...
exports.CreateHeartbeatPacket		= ()		=> this.CreatePacket(0, 0);
exports.CreateClientConnectPacket	= (usrId)	=> this.CreatePacket(1, usrId);
exports.CreateClientClosePacket		= (usrId)	=> this.CreatePacket(2, usrId);