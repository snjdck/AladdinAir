...
exports.CreatePacket = function(msgId, usrId, svrId, msgData){
	var packet;
	if(msgData == null){
	...
	packet.writeUInt16BE(svrId, 6);
	return packet;
};

exports.ReadMsgId	= packet => packet.readUInt16BE(2);
exports.ReadUsrId	= packet => packet.readUInt16BE(4);
exports.ReadSvrId	= packet => packet.readUInt16BE(6);

exports.WriteUsrId	= (packet, usrId)	=> packet.writeUInt16BE(usrId, 4);
exports.WriteSvrId	= (packet, svrId)	=> packet.writeUInt16BE(svrId, 6);
...
class Packet
{
	constructor(socket, msgId, msgData){
		this.socket = socket;
		this.msgId = msgId;
	...
	sendTo(svrId, usrId){
		this.socket.sendPacket(this.msgId, usrId, svrId, this.msgData);
	}

	forward(packet){
		this.sendTo(packet.svrId, packet.usrId);
	}
}

Socket.prototype.createPacket = function(msgId, msgData){
	return new Packet(this, msgId, msgData);
};
